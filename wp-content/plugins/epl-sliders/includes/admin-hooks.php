...
function epl_slider_extensions_options_filter( $epl_fields = null ) {
	...
	$fields[] = array(
		...
		'fields'	=>	apply_filters('epl_slider_tab_settings',array(
			...
			array(
				'name'		=>	'epl_slider_enable_lazy',
				'label'		=>	__('Lazy load images?','epl-sliders'),
				'type'		=>	'radio',
				'opts'		=>	array(
					'true'		=>	__('Enable','epl-sliders'),
					'false'		=>	__('Disable','epl-sliders'),
				...
				'default'	=>	'false',
				'help'		=>	__( 'Dynamic image loading, improves page loading speed.' , 'epl-sliders')
			),

			array(
				'name'		=>	'epl_slider_LazyLoading',
				'label'		=>	__('Number of images to Lazy Load','epl-sliders'),
				'type'		=>	'number',
				'default'	=>	'3',
				'help'		=>	__('If this value is 0, it will load current slide only. If this value is 1, it will load current slide and 1 adjacent slide.','epl-sliders')
			),
			...
			array(
				'name'		=>	'epl_slider_crop',
				'label'		=>	__('Image cropping?','epl-sliders'),
				'type'		=>	'radio',
				'opts'		=>	array(
					'true'		=>	__('Enable','epl-sliders'),
					'false'		=>	__('Disable','epl-sliders'),
				...
				'default'	=>	'true',
				'help'		=>	__( 'Crops each slider image based on assigned width & height. Disable if images are about right size.' , 'epl-sliders')
			),
			array(
				'name'		=>	'epl_slider_crop_alignment',
				'label'		=>	__('Crop Alignment','epl-sliders'),
				'type'		=>	'radio',
				'opts'		=>	array(
					'c'			=>	__('Center','epl-sliders'),
					't'			=>	__('Top','epl-sliders'),
					'b'			=>	__('Bottom','epl-sliders'),
				),
				'default'	=>	'c',
				'help'		=>	__( 'Images will be cropped from top / bottom / center.' , 'epl-sliders')
			),
			array(
				'name'		=>	'epl_slider_crop_quality',
				'label'		=>	__('Crop Quality','epl-sliders'),
				'type'		=>	'number',
				'default'	=>	70,
				'help'		=>	__( 'Image quality of cropped images, 100 is best 0 is worst.' , 'epl-sliders')
			),
	...
	$fields[] = array(
		...
		'fields'	=>	apply_filters('epl_slider_tab_mobile_settings',array(
			...
			array(
				...
				'label'		=>	__('Thumbnails on mobile devices?','epl-sliders'),
				'type'		=>	'radio',
				'opts'		=>	array(
					'0'		=>	__('Disable','epl-sliders'),
					'1'		=>	__('Enable','epl-sliders'),
  				...
  				if ($(\'input[name="epl_slider_upload_button"]\').length > 0) {
					...
					frame.on("close",function() {
						...
						selection.each(function(attachment) {
									...
									<img src="`+attachment.sizes["epl-image-medium-crop"].url+`">
								</li>
						            `;
...
function epl_slider_attachments_callback($post) {
	...
	if ( $attachments ) {
		...
		$content = '<div class="update-nag">'.__('Add images to the slider using add media button.','epl-sliders').'</div>
					<ul id="epl-slider-post-attachments" class="epl-slider-post-attachments">
					</ul>';
		$content .= '<div class="epl-clearfix"></div>';
		$content .= '<div class="update-nag">'.__("Drag to reorder images and use the switch to remove images from the slider. Update the post to save changes. $reverse_note",'epl-sliders').'</div>';
	}
