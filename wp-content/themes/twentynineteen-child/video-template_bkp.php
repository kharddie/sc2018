    ...
    <main id="main" class="site-main">
        <div class="our-video-page page-content">
            ...
            <div class="one-col-page-holder with-videos">
                    ...
                    <div class="epl-loop-tool epl-tool-sorting epl-properties-sorting epl-clearfix">
                        <select id="epl-sort-listings">
                            ...
                            foreach ($terms as $cat) :
                                ...
                                ///echo $cat->slug;
                                if ($cat->slug == 'front-page-videos') {
                                    $cat->name = 'Home page videos';
                                    $cat->slug = 'home-page-videos';
                                }
                            ?>
                ...
                //echo "post-cat=" . $post_cat . "<br>";
                if (empty($post_cat) || $post_cat == "all-videos") {
                    // echo "initaite";
                    $tax_query[] = array(
                        'taxonomy' => 'classification',
                        'field'    => 'slug',
                ...
                } else if ($post_cat == "home-page-videos") {
                    // echo "home-page-videos";
                    $tax_query[] = array(
                        'taxonomy' => 'classification',
                        'terms' => 'front-page-videos',
                        'field' => 'slug',
                    );
                } else if ($post_cat == "market-reports-videos") {
                    // echo "market-reports-videos";
                    $tax_query[] = array(
                        'taxonomy' => 'classification',
...
<script>
    jQuery(document).ready(function() {
        ...
        function changeListing() {
            ...
            if (str.indexOf("all-videos") > -1) {
                var optionToSelect = "all-videos";
                jQuery("#epl-sort-listings").val(optionToSelect);
                jQuery("#epl-sort-listings option[value=3]").attr('selected', 'selected');
            }
            if (str.indexOf("home-page-videos") > -1) {
                var optionToSelect = "home-page-videos";
                jQuery("#epl-sort-listings").val(optionToSelect);
                jQuery("#epl-sort-listings option[value=3]").attr('selected', 'selected');
            }
            if (str.indexOf("market-reports-videos") > -1) {
                var optionToSelect = "market-reports-videos";
                jQuery("#epl-sort-listings").val(optionToSelect);
                jQuery("#epl-sort-listings option[value=3]").attr('selected', 'selected');
            }
        }
